...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Dil"),
        ("Keep SNTL-RemoteAccess background service", "RustDesk arka plan hizmetini sürdürün"),
        ...
        ("Show SNTL-RemoteAccess", "RustDesk'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ("Elevate", "Yükseltme"),
        ...
        ("About SNTL-RemoteAccess", "RustDesk Hakkında"),
