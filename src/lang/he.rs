...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep SNTL-RemoteAccess background service", "השאר את שירות הרקע של RustDesk פעיל"),
        ...
        ("Show SNTL-RemoteAccess", "הצג את RustDesk"),
        ("This PC", "מחשב זה"),
        ("or", "או"),
        ...
        ("About SNTL-RemoteAccess", "אודות RustDesk"),
