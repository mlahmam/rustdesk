...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "ენა"),
        ("Keep SNTL-RemoteAccess background service", "RustDesk-ის ფონური სერვისის შენარჩუნება"),
        ...
        ("Show SNTL-RemoteAccess", "RustDesk-ის ჩვენება"),
        ...
        ("About SNTL-RemoteAccess", "RustDesk-ის შესახებ"),
