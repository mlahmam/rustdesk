...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Γλώσσα"),
        ("Keep SNTL-RemoteAccess background service", "Διατήρηση της υπηρεσίας παρασκηνίου του RustDesk"),
        ...
        ("Show SNTL-RemoteAccess", "Εμφάνιση του RustDesk"),
        ...
        ("About SNTL-RemoteAccess", "Πληροφορίες για το RustDesk"),
