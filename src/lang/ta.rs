...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "மொழி"),
        ("Keep SNTL-RemoteAccess background service", "RustDesk பின்புல சேவையை வைத்திரு"),
        ...
        ("Show SNTL-RemoteAccess", "RustDesk ஐ காட்டு"),
        ("This PC", "இந்த PC"),
        ("or", "அல்லது"),
        ("Elevate", "உயர்த்து"),
        ...
        ("About SNTL-RemoteAccess", "RustDesk பற்றி"),
