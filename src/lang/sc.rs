...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep SNTL-RemoteAccess background service", "Mantene su servìtziu de RustDesk in s'isfundu"),
        ...
        ("Show SNTL-RemoteAccess", "Mustra RustDesk"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ("Elevate", "Cresche"),
        ...
        ("About SNTL-RemoteAccess", "Informatziones subra de RustDesk"),
