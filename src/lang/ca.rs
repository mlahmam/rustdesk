...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Idioma"),
        ("Keep SNTL-RemoteAccess background service", "Manté el servei del RustDesk en rerefons"),
        ...
        ("Show SNTL-RemoteAccess", "Mostra el RustDesk"),
        ...
        ("About SNTL-RemoteAccess", "Quant al RustDesk"),
