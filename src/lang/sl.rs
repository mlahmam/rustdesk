...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Jezik"),
        ("Keep SNTL-RemoteAccess background service", "Ohrani RustDeskovo storitev v ozadju"),
        ...
        ("Show SNTL-RemoteAccess", "Prikaži RustDesk"),
        ...
        ("About SNTL-RemoteAccess", "O RustDesku"),
