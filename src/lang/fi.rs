...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Kieli"),
        ("Keep SNTL-RemoteAccess background service", "Pidä RustDeskin taustapalvelu käynnissä"),
        ...
        ("Show SNTL-RemoteAccess", "Näytä RustDesk"),
        ...
        ("About SNTL-RemoteAccess", "Tietoa RustDeskistä"),
