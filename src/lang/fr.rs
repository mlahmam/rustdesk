...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Langue"),
        ("Keep SNTL-RemoteAccess background service", "Garder le service RustDesk en arrière plan"),
        ...
        ("Show SNTL-RemoteAccess", "Afficher RustDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("About SNTL-RemoteAccess", "À propos de RustDesk"),
