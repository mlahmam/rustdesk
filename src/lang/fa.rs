...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep SNTL-RemoteAccess background service", "را در پس زمینه نگه دارید RustDesk سرویس"),
        ...
        ("Show SNTL-RemoteAccess", "RustDesk نمایش"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ("Elevate", "ارتقاء"),
        ...
        ("About SNTL-RemoteAccess", "RustDesk درباره"),
