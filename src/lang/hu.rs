...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Nyelv"),
        ("Keep SNTL-RemoteAccess background service", "RustDesk futtatása a háttérben"),
        ...
        ("Show SNTL-RemoteAccess", "A RustDesk megjelenítése"),
        ...
        ("About SNTL-RemoteAccess", "A RustDesk névjegye"),
