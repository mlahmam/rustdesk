...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep SNTL-RemoteAccess background service", "Zachovat službu RustDesk na pozadí"),
        ...
        ("Show SNTL-RemoteAccess", "Zobrazit RustDesk"),
        ...
        ("About SNTL-RemoteAccess", "O RustDesk"),
