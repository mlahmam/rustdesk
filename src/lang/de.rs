...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Sprache"),
        ("Keep SNTL-RemoteAccess background service", "RustDesk im Hintergrund ausführen"),
        ...
        ("Show SNTL-RemoteAccess", "RustDesk anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("About SNTL-RemoteAccess", "Über RustDesk"),
